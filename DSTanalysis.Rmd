...
#        dev.off()
        ...
        DSTbaseline=rep(1,length(week2week$RateRatio)) #As DST is the reference, we're comparing to this
        print(t.test(week2week$RateRatio,DSTbaseline))
        print(cohen.d(week2week$RateRatio,DSTbaseline))
